...
//#warning iap identifier
#define CP_Golden_ProductIDs @[@"com.idreems.makeup"]

#define CP_Golden_price(index) [@[@"6"] objectAtIndex:index]

#define CP_Golden_values @[@"600"] 



#define kCPPaidForGoldsNotificatioin @"kCPPaidForGoldsNotificatioin"
#define kCurrentGoldInt [[USER_DEFAULT objectForKey:@"CurrentGolden"] intValue]
#define kSetCurrentGold(value) [USER_DEFAULT setInteger:(value) forKey:@"CurrentGolden"];\
