//
//  ViolationHistoryViewController.m
...
@interface ViolationHistoryViewController ()

@end

@implementation ViolationHistoryViewController
...
-(void)initViews
{
    ...
    placeHolderTextView.text = @"正在开发，优先级 3";
